        ...
        <!--<span class="select">
            ...
            <span id="lne" style="display:none" onMouseOut="logclose()" onMouseOver="logmine()">
                <span style="background:#fff;">
                	<a href="/mycourse/mycourse" style="width:70px; display:block;" class="link2 he ico" target="_blank">sherley</a>
                </span>
...
<div class="content">
    ...
    <div class="td1">
        <div class="tdcont">
            ...
            <p><a href="/course/courselist" class="btninto">开始学习</a></p>
        </span>
...
点，点点精通。</p><br/>
    ...
    <div class="crdiv">
        ...
        <span class="morecourse"><a href="/course/courselist" class="btnlink">更多课程</a></span>
