                    ...
                    <dl class="mulu noo">
                        <div>
                            ...
                            <div class="mulu_con">
                                ...
                                <a href="/course/video"><dd><strong class="cataloglink">课时1：会计的概念与目标1</strong><i class="fini nn"></i></dd></a>
                                <a href="/course/video"><dd><strong class="cataloglink">课时2：会计的概念与目标2</strong><i class="fini fn"></i></dd></a>
                                <dd class="smalltitle"><strong>第二节&nbsp;&nbsp;会计的职能与方法</strong></dd>
                                <a href="/course/video"><dd><strong class="cataloglink">课时1：会计的职能与方法1</strong><i class="fini nn"></i></dd></a>
                                <a href="/course/video"><dd><strong class="cataloglink">课时2：会计的职能与方法2</strong><i class="fini fn"></i></dd></a>
                                <a href="/course/video"><dd><strong class="cataloglink">课时1：会计的职能与方法3</strong><i class="fini ff"></i></dd></a>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="mulu_con">
                                ...
                                <a href="/course/video"><dd><strong class="cataloglink">课时1：会计要素与会计等式1</strong><i class="fini nn"></i></dd></a>
                                <a href="/course/video"><dd><strong class="cataloglink">课时2：会计要素与会计等式2</strong><i class="fini nn"></i></dd></a>
                            </div>
                        </div>
                    </dl>
                </div>
            ...
            <div class="cr1">
                ...
                <div class="teacher">
                    <div class="teapic ppi">
                        <a href="/teacher/teacher" target="_blank"><img src="/index/images/teacher.png" width="80" class="teapicy" title="张民智"></a>
                        <h3 class="tname"><a href="/teacher/teacher" class="peptitle" target="_blank">张民智</a><p style="font-size:14px;color:#666">会计讲师</p></h3>
                    </div>
                    <div class="clearh"></div>
