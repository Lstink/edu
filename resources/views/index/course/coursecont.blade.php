...
<div class="coursecont">
    ...
    <div class="coursetext">
        ...
        <dl class="mulu">
            <dt><a href="/course/coursecont1" class="graylink">第一章&nbsp;&nbsp;总论</a></dt>
            ...
            <div class="cr1">
                ...
                <div class="teacher">
                    <div class="teapic ppi">
                        ...
                        <h3 class="tname"><a href="/teach/teacher" class="peptitle" target="_blank">张民智</a><p style="font-size:14px;color:#666">会计讲师</p></h3>
                    </div>
                    <div class="clearh"></div>
